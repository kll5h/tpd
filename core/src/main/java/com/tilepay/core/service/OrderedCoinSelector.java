...
/**
 * Using BitcoinJ DefaultCoinSelector, 
 * substituted HashSet with LinkedHashSet to get ordered outputs
 */
...
public class OrderedCoinSelector implements CoinSelector {
    @Override
    ...
    static void sortOutputs(ArrayList<TransactionOutput> outputs) {
        Collections.sort(outputs, new Comparator<TransactionOutput>() {
            ...
            public int compare(TransactionOutput a, TransactionOutput b) {
                ...
                if (conf1.getConfidenceType() == ConfidenceType.BUILDING)
                    depth1 = conf1.getDepthInBlocks();
                if (conf2.getConfidenceType() == ConfidenceType.BUILDING)
    ...
    public static boolean isSelectable(Transaction tx) {
        ...
        return type.equals(ConfidenceType.BUILDING) ||
                type.equals(ConfidenceType.PENDING) && confidence.getSource().equals(Source.SELF) &&
